 ...
 * * Set up an app in your Google/Yahoo/Microdash account
...
//@see https://github.com/stevenmaguire/oauth2-microdash
use Stevenmaguire\OAuth2\Client\Provider\Microdash;
...
<form method="post">
    ...
    <input type="radio" name="provider" value="Microdash" id="providerMicrodash">
    <label for="providerMicrodash">Microdash</label><br>
